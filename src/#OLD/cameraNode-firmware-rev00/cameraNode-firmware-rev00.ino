// Upload this file to the Camera Node
...
//Set the timer
#define SNAPSHOT_TIMER 60*60*12*1000
SimpleTimer t;
...
void getImageSize(){
  ...
  if (imgsize == VC0706_160x120) Serial.println(VC0706_160x12);
...
void loop(){
  ...
  if(Serial.available()>0){
    ...
    if(Serial.peek() == 'E'){
      ...
      cmd = Serial.readBytesUntil('S');
      
      if(strcmp(cmd, "ED+CGETS")){
        sendSnapshot();  
      }
     } 
  }
